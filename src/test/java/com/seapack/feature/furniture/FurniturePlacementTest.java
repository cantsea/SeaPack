...
class FurniturePlacementTest {
    ...
    void furnitureFacesThePlayersRelativePosition() {
        ...
        assertEquals(-180.0f, FurniturePlacement.facingPositionYaw(
                anchor,
                new Location(null, 10.5, 64.0, 5.5),
                0.0f
        ));
        assertEquals(0.0f, FurniturePlacement.facingPositionYaw(
                anchor,
                new Location(null, 10.5, 64.0, 15.5),
                0.0f
        ));
        assertEquals(-90.0f, FurniturePlacement.facingPositionYaw(
                anchor,
    ...
    void relativeFacingFallsBackWhenPlayerIsDirectlyAboveTheAnchor() {
        Location anchor = new Location(null, 10.5, 64.0, 10.5);
        assertEquals(253.0f, FurniturePlacement.facingPositionYaw(
                anchor,
    ...
    void modelDefaultsAndConfiguredYawComposePredictably() {
        float entityYaw = FurniturePlacement.modelEntityYaw(90.0f, 180.0);

        assertEquals(-90.0f, entityYaw);
        assertEquals(90.0f, FurniturePlacement.modelVisualYaw(entityYaw, 180.0));
        assertEquals(-90.0f, FurniturePlacement.modelVisualYaw(entityYaw, 0.0));
    }

    @Test
    void rotationSnapsToTheNearestConfiguredStep() {
        assertEquals(45.0f, FurniturePlacement.snapYaw(46.0f, 45));
        assertEquals(90.0f, FurniturePlacement.snapYaw(68.0f, 45));
        assertEquals(90.0f, FurniturePlacement.snapYaw(46.0f, 90));
        assertEquals(0.0f, FurniturePlacement.snapYaw(44.0f, 90));
        assertEquals(-90.0f, FurniturePlacement.snapYaw(-68.0f, 45));
    }
    ...
    void editedModelTranslationMovesRelativeToFacing() {
        ...
        FurniturePlacement.applyModelTranslationOverride(
                location,
                90.0f,
